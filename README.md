...
- Update: Modify existing expense entries.
...
- Home Page:- After logging in, you'll arrive at the Home Page, featuring four key buttons:- Expenses List: Navigate to view all recorded expenses.
- Add New Expenses: Access a form to input new expense details, including title, amount, and date and other.
- Edit Expenses:- In the Expenses List, select an expense link entry to modify its details (e.g., update the amount or description).
- Save the changes to update the record in the SQLite database.

- Logout: Exit the app securely.
- Reset: Remove all stored data by clearing the SQLite database.
